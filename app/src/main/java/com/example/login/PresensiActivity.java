...
public class PresensiActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void showAlertDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(PresensiActivity.this);
